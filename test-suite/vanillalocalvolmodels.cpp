...
BOOST_AUTO_TEST_SUITE(VanillaLocalVolModelTests)
...
BOOST_AUTO_TEST_CASE(testNormalModelBoundaryCase) {
...
BOOST_AUTO_TEST_CASE(testShiftedLognormalModelBoundaryCase) {
...
BOOST_AUTO_TEST_CASE(testSmileCalibration) {
